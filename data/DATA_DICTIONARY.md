...
| `rtolcap_mw` | Real-Time On-Line Reserve Capacity (RTOLCAP), MW. |
| `rtoffcap_mw` | Real-Time Off-Line Reserve Capacity (RTOFFCAP), MW. |
| `rtordpa` | Real-Time On-Line Reliability Deployment Price Adder (RTORDPA), USD/MWh. |
...
| `rtolhsl_mean` | Mean Real-Time On-Line High Sustained Limit within the hour, MW. |
